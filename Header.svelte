<script>
    let { children, headline, dek, authors, spotColor, hero } = $props()
</script>



<div class="xl:max-w-[1550px] lg:max-w-[1000px] xl:aspect-[4/3] lg:aspect-[4/3] md:aspect-[4/3] xs:aspect-[4/3] bg-no-repeat bg-cover xs:bg-right mx-auto relative mb-2" style="background-size:cover;background-position:center;background-image: url('https://arc.stimg.co/startribunemedia/{hero}.png?dpr=2');">
